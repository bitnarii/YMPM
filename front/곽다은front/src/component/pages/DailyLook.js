...
import NewOpinion from "../../ui/dailyLookUi/NewOpinion";
import Opinion from "../../ui/dailyLookUi/Opinion";
...
<div id="u604" className="ax_default text_field">
  ...
  <input id="u604_input" type="readOnly" placeholder={list.dailyLookName} />
</div>
...
<div id="u601" className="ax_default" data-left="1" data-top="131" data-width="400" data-height="708">
{/* 인체그리드 */}
<Body />
  {/* 사진 */}
<Photo />
...
{/* 숫자버튼 */}
<div id="u631" className="ax_default" data-label="Pagination" data-left="171" data-top="799" data-width="61" data-height="27">

  
  <div id="u632" className="ax_default box_3 selected" selectiongroup="My Pagination Group">
  ...
  <div id="u633" className="ax_default box_3" selectiongroup="My Pagination Group">
...
<select value={index} onChange={onSelect}>
  <option value="0">새 댓글 쓰기</option>
  <option value="1">댓글 보기</option>
</select>
{index === "0" ? <NewOpinion /> : null}
