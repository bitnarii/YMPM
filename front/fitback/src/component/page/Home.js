    ...
    return ( 
        ...
        <Container>
            <Row>
               ...
               <div style={{position: "absolute", marginTop: "165px", marginLeft:"860px"}}><img style={{width: "170px", height: "319px"}} src="https://image.musinsa.com/mfile_s01/_shopstaff/view.staff_6260b1fb6979e.jpg?20220421103004" alt=""/></div>
                ...
                <InputGroup >
                    ...
                    <FormControl style={{marginTop: "4px", height: "25px", borderLeft: "transparent", borderRight: "transparent"}}/>
                </InputGroup>
                ...
                <InputGroup style={{marginTop: "5px", }}>
                    ...
                    <FormControl style={{marginTop: "6px", height: "25px", width: "77px", borderLeft: "transparent", borderRight: "transparent"}}/>
                </InputGroup>
                ...
                <InputGroup>
                    <FormControl style={{height: "25px", borderLeft: "transparent", borderRight: "transparent"}}/>
                </InputGroup>
            ...
            <FormControl value="대표 옷장" style={{textAlign: "center", marginLeft: "29px", marginTop: "20px", height: "25px", width: "300px", borderLeft: "transparent", borderRight: "transparent"}}/>
                ...
                <Badge bg="black" style={{maarginTop: "250px", marginLeft: "55px"}}>대표 옷장 바꾸기</Badge>
                </Card.Body>
            </Card>
